...
enviar2.addEventListener('click', () => {
    ...
    notas1b [1] = Number(document.getElementById('matematica2').value)
    notas2b [1] = Number(document.getElementById('portugues2').value)
    notas3b [1] = Number(document.getElementById('ciencia2').value)
    notas4b [1] = Number(document.getElementById('geografia2').value)
    console.log(notas1b)
    console.log(notas2b)
    console.log(notas3b)
    console.log(notas4b)
...
enviar3.addEventListener('click', () => {
    ...
    notas1b [2] = Number(document.getElementById('matematica3').value)
    notas2b [2] = Number(document.getElementById('portugues3').value)
    notas3b [2] = Number(document.getElementById('ciencia3').value)
    notas4b [2] = Number(document.getElementById('geografia3').value)
    console.log(notas1b)
    console.log(notas2b)
    console.log(notas3b)
    console.log(notas4b)
...
enviar4.addEventListener('click', () => {
    ...
    notas1b [3] = Number(document.getElementById('matematica4').value)
    notas2b [3] = Number(document.getElementById('portugues4').value)
    notas3b [3] = Number(document.getElementById('ciencia4').value)
    notas4b [3] = Number(document.getElementById('geografia4').value)
    console.log(notas1b)
    console.log(notas2b)
    console.log(notas3b)
    console.log(notas4b)
